...
- [📄 Documento Técnico](./docs/documento-tecnico.md) — Arquitetura, Stack, Réguas, Decisões, Plano de execução
...
> 📄 **Arquitetura completa e Stack Tecnológico** com diagramas, fluxo de dados e justificativas detalhadas estão no [Documento Técnico](./docs/documento-tecnico.md).
